  ...
  return (
    <div className="section">
      <div className="container">
        ...
        <div className="section__block">
          <h2>
            7. Материально-техническое обеспечение и оснащенность образовательного
          ...
          <h3>
            * Электронные документы подписываются простой электронной подписью
          </h3>
        </div>
        {/*  */}
        <div className="section__block">
          ...
          <a href="">приказ об утверждении стоимости </a>
        </div>
        ...
        {/*  */}
        <div className="section__block">
          <h2>10. Вакантные для приема (перевода) обучающихся</h2>
          <p>
