    ...
    <div className="section">
      <div className="container">
        ...
        <div className="section__block">
          ...
          <p>
            <a href="/Программа ДО Elementary New Headway(С КЭП).pdf">Программа ДО Elementary New Headway(С КЭП).pdf</a>
          </p>
          <p>
            <a href="/Программа на сайт 72 ч (10 дн.)(С КЭП) 2023.pdf">Программа на сайт 72 ч (10 дн.)(С КЭП) 2023.pdf</a>
          </p>
          <p>О языках образования:</p>
          <p>
            <a href="/Положение о языке(С КЭП).pdf">Положение о языке(С КЭП).pdf</a>
          </p>
        </div>
        <div className="section__block">
          <h2>5. Руководство</h2>
        ...
        <div className="section__block">
          ...
          <a href="/documents/GEOTEK/ПРИКАЗ об утв.стоим. ДПО 2025(С КЭП).pdf">Приказ об утверждении стоимости</a>
        </div>
